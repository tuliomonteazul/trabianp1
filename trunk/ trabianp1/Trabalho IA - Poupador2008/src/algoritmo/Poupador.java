...
public class Poupador extends ProgramaPoupador {
	...
	private static final int VISAO_POUP = 0;
	private static final int VISAO_LADRAO = -100;
	private static final int VISAO_MOEDA = 50;
	private static final int VISAO_BANCO = 0;
...
//		}
	...
	private int[] ponderarOlfato(int[] ambienteOlfatoPoupador) {
		...
		for (int i = 0; i < 8; i++) {
			if (ambienteOlfatoPoupador[i] == 0) {
				// se o olfato for 0, pondera como 1 (para ser multiplicado por 1 e n�o ser alterado o valor)
				mtzPonderada[i] = 1;
				
			} else if (ambienteOlfatoPoupador[i] >= 1) {
				// se o olfato for maior que 1, pondera com o modulo da
				// diferen�a do valor por 6, ex. para valor = 1, o valor
				// ponderado = 5
	...
	private int realizarAcao(int acaoAtual) {
		...
		// valor maximo � o ultimo valor da lista
...
//				if (i < 10) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: MEU DEUS!!!! Fugir do ladrao ACIMA");
//					}
//					return BAI;
//				}
//				if (i == 10 || i == 11) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: MEU DEUS!!!!  Fugir do ladrao AESQUERDA");
//					}
//					return DIR;
//				}
//				if (i == 12 || i==13) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: MEU DEUS!!!!  Fugir do ladrao ADIREITA");
//					}
//					return ESQ;
//				}
//				if (i > 14) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: MEU DEUS!!!!  Fugir do ladrao ABAIXO");
//					}
//					return CIM;
//				}
//			} else if (visao == 3 || visao == 4 || visao == 5) {
//				if (i < 10) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: OPA, moeda, banco ou pastilha PRACIMA.");
//					}
//					return CIM;
//				}
//				if (i == 10 || i == 11) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: OPA, moeda, banco ou pastilha PRAESQUERDA.");
//					}
//					return ESQ;
//				}
//				if (i == 12 || i==13) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: OPA, moeda, banco ou pastilha PRADIREITA.");
//					}
//					return DIR;
//				}
//				if (i > 14) {
//					if (sysoutar) {
//						System.out.println("POUPADOR: OPA, moeda, banco ou pastilha PRABAIXO.");
//					}
//					return BAI;
//				}
//			}
